...
class Dots {
    ...
    draw() {
        ...
        ctx.fillStyle = 'rgba(24, 129, 141, .07)';
...
class Circuits {
    ...
    draw() {
        ...
        ctx.strokeStyle = 'rgba(168, 240, 248, 1)';
        ...
        ctx.lineWidth = ~~(this.size/4.6);
        ctx.strokeStyle = 'rgba(168, 240, 248, .62)';
        this.collection.forEach(circuit => {
            ctx.beginPath();
...
class Things {
    ...
    draw() {
        ...
        ctx.fillStyle = 'rgba(186, 242, 247, .78)';
        this.collection.forEach(thing => {
            ctx.beginPath();
    ...
    setLight(lightRadius) {
        ...
        gradient.addColorStop(1, "rgba(24, 129, 141, .38)");
        ...
        gradient.addColorStop(1, "rgba(37, 203, 223,  .22)");
